...
A React + Vite lab guide site styled with IBM Carbon-inspired branding. Hosts six hands-on labs for IBM Bob Premium for Z, and deploys automatically to GitHub Pages from the `Zappmod/ICE-Bobathon` repo.

**Live site:** [https://zappmod.github.io/ICE-Bobathon/](https://zappmod.github.io/ICE-Bobathon/)
...
```
https://zappmod.github.io/ICE-Bobathon/
```
...
Open [http://localhost:5173/ICE-Bobathon/](http://localhost:5173/ICE-Bobathon/)

> **Note:** This is the public version hosted at `Zappmod/ICE-Bobathon`. The original IBM-internal version lives at `CE4S/BOB-for-Z-Bobathon`.
